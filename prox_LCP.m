function [x, err, iter, flag, convergence, msg] = prox_LCP(A, b, x0, max_iter, tol_rel, tol_abs, profile)
% Demonstrated equivalence between prox solver and pgs solver for LCP model
